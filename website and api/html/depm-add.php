    ...
    <div class="col-lg-12">
      <div class="card">
        ...
        <div class="card-body">
          <form class="row g-3">
            <div class="col-md-6">
              <label for="inputFullName4" class="form-label">First Name</label>
              <input type="text" class="form-control" id="inputFullName4">
            </div>
            <div class="col-md-6">
              <label for="inputFullName4" class="form-label">Last Name</label>
              <input type="text" class="form-control" id="inputFullName4">
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <select id="inputUserStatus" class="form-select">
                <option selected>Choose...</option>
                <option>...</option>
              </select>
            </div>
            <label class="form-label">User Permission</label>
            <div class="col-12" style="border: 1px solid #ccc;border-radius: 10px;padding: 15px 15px;margin: 0px 10px;max-width: 97.5%;">
              <div class="col-md-3">
