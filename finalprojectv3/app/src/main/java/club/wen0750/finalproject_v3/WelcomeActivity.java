package club.wen0750.finalproject_v3;
...
public class WelcomeActivity extends AppCompatActivity {
    ...
    public void welcome_button(View view) {
        if (view.getId() == R.id.welcome_button_login) {
            Intent page = new Intent(this, club.wen0750.finalproject_v3.SignInActivity.class);
            startActivity(page);
        } else if (view.getId() == R.id.welcome_button_user_reg) {
            Intent page = new Intent(this, club.wen0750.finalproject_v3.SignUpActivity.class);
            startActivity(page);
        } else if (view.getId() == R.id.welcome_button_shop_reg) {
            Intent page = new Intent(this, club.wen0750.finalproject_v3.ShopRegisterActivity.class);
            startActivity(page);
        }
    }
